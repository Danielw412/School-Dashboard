...
export const defaultSettings: AppSettings = {
  ...
  prompts: {
    ...
    assignmentNavigation: `Investigate the selected assignment deterministically first. Read its Canvas directions, submission requirements, containing module, linked pages, files, and same-origin Canvas resources. Produce a very short, direct student-facing paraphrase: a two-sentence overview at most, a few brief steps, exact assigned work, and one-line submission and due details. Preserve exact problem numbers, page numbers, deliverables, deadlines, and warnings without repetition. Follow only relevant links. Do not claim access to an external platform unless its content was actually available.`,
  },
