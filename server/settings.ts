...
export const defaultSettings: AppSettings = {
  ...
  prompts: {
    ...
    assignmentNavigation: `Investigate the selected assignment deterministically first. Read its Canvas directions, submission requirements, containing module, linked pages, files, and same-origin Canvas resources. Produce a clear student-facing paraphrase when the source directions are verbose, while preserving exact assigned problem numbers, page numbers, deliverables, deadlines, and warnings. Follow only links relevant to the assignment. Do not claim access to an external platform unless its content was actually available.`,
  },
